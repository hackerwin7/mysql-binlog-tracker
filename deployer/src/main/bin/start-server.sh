...
then
    ...
    echo conf : $conf
    cd $base
    $JAVA $JAVA_OPTS $JAVA_DEBUG_OPT $TRACKER_OPTS -classpath .:$CLASSPATH com.github.hackerwin7.deployer.LogTrackerTopologyFile 1>>$base/logs/tracker/console.log 2>&1 &
