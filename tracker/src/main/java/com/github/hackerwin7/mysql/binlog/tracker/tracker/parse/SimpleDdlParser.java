...
import com.github.hackerwin7.mysql.binlog.tracker.tracker.common.PatternUtils;
...
public class SimpleDdlParser {
    ...
    public static class DdlResult {
        ...
        private EventEntry.EventType type;
        ...
        public EventEntry.EventType getType() {
            return type;
        }

        public void setType(EventEntry.EventType type) {
            this.type = type;
        }
